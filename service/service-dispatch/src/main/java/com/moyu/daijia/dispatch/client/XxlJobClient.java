...
import com.moyu.daijia.dispatch.config.XxlJobClientConfig;
import com.moyu.daijia.model.entity.dispatch.XxlJobInfo;
...
public class XxlJobClient {
    ...
    public Long addAndStart(String executorHandler, String param, String corn, String desc) {
        ...
        log.info("提交任务入参：{}", JSON.toJSONString(xxlJobInfo));
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<XxlJobInfo> request = new HttpEntity<>(xxlJobInfo, headers);
